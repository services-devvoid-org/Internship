...
const Banner = () => {
  return (
    <section
      className="min--[85vh] lg:min-h-[78vh] flex items-center"
      id="home"
    >
        ...
        <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12">
          <div className="flex-1 text-center font-secondary lg:text-left">
            ...
            <motion.p  variants={fadeIn("up", 0.5)}
              initial="hidden"
              whileInView={"show"}
              viewport={{ once: false, amount: 0.7 }} className="mb-8 max-w-lg max-auto lg:mx-0">Consectetur laborum amet occaecat pariatur mollit laborum commodo Lorem enim.</motion.p>
